...
module.exports = ctx => {
  ...
  helper.register('forname', require(`./helper48/forname`));
  helper.register('team', team.team);
  helper.register('stage_team', team.stage_team);
  helper.register('stage_date', team.stage_date);
  helper.register('stage_forname', require('./helper48/stage_forname'));
  helper.register('stage_transname', require('./helper48/trans'));
